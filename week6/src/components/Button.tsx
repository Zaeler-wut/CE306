  ...
  switch (variant) {
    case "primary":
      variantStyles = `
        ...
        focus:ring-blue-500
        disabled:bg-blue-600 disabled:border-blue-600
      `;
      break;
    case "secondary":
      variantStyles = `
    ...
    case "danger":
      variantStyles = `
        ...
        focus:ring-red-500
        disabled:bg-red-600 disabled:border-red-600
      `;
      break;
    case "outline":
      variantStyles = `
        ...
        focus:ring-blue-500
        disabled:bg-transparent disabled:text-blue-600/60 disabled:border-blue-600/60
      `;
      break;
    default:
      variantStyles = `
